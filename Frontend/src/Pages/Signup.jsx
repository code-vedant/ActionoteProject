  ...
  return (
    <>
      ...
      <main className="w-screen h-screen overflow-hidden flex flex-col justify-center items-center dark:bg-[#1d1d1d] dark:text-white">
        ...
        <h3 className="text-7xl z-20 lg:text-8xl font-light text-center mt-2">
        ...
        <div className="form-left z-20 w-full h-screen flex items-start justify-center pt-10 lg:pt-5">
          <div className="w-11/12 lg:w-1/3 h-fit lg:h-[82vh] border bg-white shadow-gray-100 dark:shadow-gray-600 shadow-md dark:bg-[#1d1d1d] px-4 pb-5 lg:px-16">
            ...
            >
              ...
              <button
                type="submit"
                disabled={loading}
                className={`bg-[#39a2ff] text-white font-bold py-2 px-4 mt-2 rounded-full ${
                  loading
